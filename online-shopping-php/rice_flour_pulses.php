	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Rice, Flour & Pulses
			...
			<div class="agileinfo-ads-display col-md-9 w3l-rightpro">
				<div class="wrapper">
					...
					<div class="product-sec1">
						...
						<?php  
				$kitchensql = mysqli_query($conn, "SELECT * FROM product WHERE category = 'Rice, Flour & Pulses' ORDER BY pro_id DESC");
